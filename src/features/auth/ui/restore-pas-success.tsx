...
export const RestorePassSuccess = () => {
    return (
        <div className="flex flex-col items-center justify-center gap-7 w-[360px] py-10 bg-white rounded-[16px]">
            ...
            <div className="flex flex-col gap-[11px] text-center">
                <h3 className="font-bold text-[18px] text-[#161616]">Заявка принята</h3>
                <p className="font-medium text-[12px] leading-[15px] text-[#8B8B8B]">
                    Запрос на восстановление пароля отправлен
                </p>
            </div>
        </div>
    );
