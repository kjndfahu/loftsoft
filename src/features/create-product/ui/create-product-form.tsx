...
export const CreateProductForm: FC<Props> = ({ setIsOpen, refetchProducts }) => {
    ...
    return (
        <form
            ...
            className="flex flex-col gap-4 w-full lg:max-w-[1100px] mdbvp:max-w-[700px] sm:max-w-[500px] max-w-[500px] pt-4 pb-7 px-2 sm:px-6 bg-white rounded-[16px] max-h-[90vh] overflow-y-auto"
        >
