...
export const Banner2 = () => {
    ...
    return (
        <div
            className={`flex flex-col relative ${background} cursor-pointer bg-cover bg-no-repeat sm:bg-[position:0px] mds:w-1/2 w-full relative gap-4 mds:p-10 p-6 sm:h-[536px] h-[240px] rounded-[20px]`}
            onClick={(e) => {
