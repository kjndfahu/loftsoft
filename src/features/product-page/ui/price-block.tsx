// /src/features/product-page/ui/price-block.tsx
"use client";
...
export const PriceBlock = ({
    ...
    const handleAddToCart = () => {
        addItem({
            ...
            oldPrice: parseFloat(regularPrice),
            photo,
            type,
            licenseType,
            deviceCount,
        ...
        <div className="flex flex-col bg-[#F5F7FF] rounded-[20px] gap-[20px] md:p-6 p-4">
            <div className="flex flex-col items-start gap-2">
                <div className="flex items-baseline gap-2">
                    ...
                    <div className="rounded-full px-[6px] font-semibold bg-[#FEECEE] py-1 text-[11px] text-[#E71730]">
                        -{discountPercentage}%
                    </div>
