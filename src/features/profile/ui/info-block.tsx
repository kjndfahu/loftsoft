    ...
    return (
        <div className="flex flex-col w-full items-center mds:justify-center justify-between overflow-hidden gap-4 mds:px-0 px-[23px] lg:pt-16 mds:pt-7 pt-24 pb-10 relative info mds:rounded-[36px] rounded-[20px] lg:h-[390px] mds:h-[289px] h-[600px]">
            ...
            <div className="flex mds:flex-row flex-col z-[5] pt-6 mds:gap-4 gap-2.5">
                ...
                <div className="flex border-[1px] bg-[#FFFFFF0F] backdrop-blur-sm rounded-[16px] border-[#FFFFFF40] items-center justify-center mds:w-auto w-[80vw] py-3 px-6 gap-2">
            ...
            <Image alt="shine" src={shine} className="absolute z-[1] lg:top-[55px] top-[30px] xl:left-[230px] lg:left-[150px] md:left-[100px] left-[50px]"/>
            <Image width={20} height={20} alt="shine" src={shine} className="absolute z-[1] -scale-x-100 mds:top-[38px] top-[190px] xl:right-[370px] lg:right-[230px] md:right-[120px] mds:right-[70px] right-[25px]"/>
            <Image width={12} height={12} alt="shine" src={shine} className="absolute z-[1] mds:top-[75px] top-[220px] xl:right-[350px] lg:right-[200px] md:right-[100px] mds:right-[50px] right-[10px]"/>
            <Image alt="spiral" src={spiral} className="absolute z-[1] mds:rotate-0 -rotate-12 aspect-445/390 lg:w-[445px] w-[330px] -scale-x-100 mds:top-0 top-[-220px] mds:right-0 right-[-100px] md:left-0 mds:left-[-120px] left-auto rounded-l-[36px]"/>
